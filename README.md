...
[Моделирование фармококинетики](https://github.com/Veretion/pharmacokinetic-modeling)
<br>Динамика концентрации лекарства в крови на примере Цифран СТ.
<br><br>

[Создание видео по кадрам из папки](https://github.com/Veretion/gen_video_from_folder)
<br>Изначально скрипт реализован для создания видео по изменению матрицы внимания во время обучения трансформера.
<br><br>
